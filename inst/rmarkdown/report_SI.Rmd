...
NMRcap <- paste('1H-NMR spectrum of the', selected.oligos.db(), 'oligonucleotide, acquired at 25°C in', db.nmr.select()$buffer.id)
```
...
MScap2 <- paste0('Native ESI-MS spectra of the ', selected.oligos.db(), ' oligonucleotide, focused on the ', input$charge.select, '$^{-}$ charge state')
```
