...
```{r mirror, message=FALSE, warning=FALSE, paged.print=FALSE}
...
+ Creation of a package to encapsulate the app, additinal functions and datasets
  ...
  - Three functions: _g4db_ to launch the app, _epsilon.calculator_ to calculate extinction coefficients of oligonucleotides (used within g4db but can be used as a standalone function), and _nb_row_extract_ that determines the number of rows in panelled figures to adjust their size within _g4db._
