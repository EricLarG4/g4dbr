...
+ Swtiched the generation of datatables client-side (as opposed to server-side) to allow for the exporting of full datasets, rather than only what is displayed.
